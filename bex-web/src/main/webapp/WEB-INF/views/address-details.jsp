                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td rowspan="5" colspan="2">
                                                <img width="200" src="<c:url value = "/api/v1/common/qrcode?text=${address.value }"/>" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Address:</th>
                                        ...
                                        <tr>
                                            <th>Balance:</th>
                                            <td>${address.balance.valueAsString()  }&nbsp;&nbsp;${address.balance.type}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                </div>
                                ...
                                <table id="tbTransaction" class="table table-responsive-sm table-hover table-outline mb-0">
                                  ...
                                  <tbody>
                                  <!-- ************************ -->
                                  <c:forEach var="block" items="${address.blocks}">
                                  <c:forEach var="tx" items="${block.transactions}" varStatus="loopCounter">
                                    <tr>
                                      ...
                                      <a href="<c:url value = "/txs/${tx.hash }?blockhash=${block.hash }?provider=${provider }"/>">${tx.hash }</a></td>
                                      <td>${tx.version }</td>
