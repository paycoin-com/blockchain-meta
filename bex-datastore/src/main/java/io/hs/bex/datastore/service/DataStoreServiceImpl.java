...
public class DataStoreServiceImpl implements DataStoreService
{
    ...
    public String createDir( DataStoreType dataStoreType, String path, boolean createParent )
    {
        try
        {
            return ( (DataStoreHandler) context.getBean( dataStoreType.getHandlerName() )).createDir( path,
                    createParent );
        }
        catch( Exception e )
        {
    ...
    @Override
    public String saveFile( DataStoreType dataStoreType, boolean createDir, String path, String fileName,
            String jsonData )
    {
        try
        {
            return ( (DataStoreHandler) context.getBean( dataStoreType.getHandlerName() )).saveFile( createDir, path,
                    fileName, jsonData );
        }
        catch( Exception e )
        {
    ...
    public String getFileContent( DataStoreType dataStoreType, String path, String fileName )
    {
        try
        {
            return ( (DataStoreHandler) context.getBean( dataStoreType.getHandlerName() )).getFileContent( path,
                    fileName );
        }
        catch( Exception e )
        {
    ...
    public FileInfo getFileInfo( DataStoreType dataStoreType, String path, String fileName )
    {
        try
        {
            return ( (DataStoreHandler) context.getBean( dataStoreType.getHandlerName() )).getFileInfo( path,
                    fileName );
        }
        catch( Exception e )
        {
    ...
    public String publishNS( String key, String nsValue )
    {
        try
        {
            return defaultDataStoreHandler.publishNS( key, nsValue );
        }
        catch( Exception e )
        {
    ...
    public String publishNS( String key, String path, String fileName )
    {
        try
        {
            return defaultDataStoreHandler.publishNS( key, path, fileName );
        }
        catch( Exception e )
        {
